...
test('Clicking submit runs spyOn Create function with inputted form data', () => {
  ...
  fireEvent.change(screen.getByPlaceholderText('Enter author'), { target: { value: 'Test Author' } })
  fireEvent.change(screen.getByPlaceholderText('Enter url'), { target: { value: 'http://test-url.com' } })
